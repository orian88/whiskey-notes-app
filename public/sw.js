...
const CACHE_NAME = 'whiskey-notes-v7';
const STATIC_CACHE_NAME = 'whiskey-notes-static-v7';
const DYNAMIC_CACHE_NAME = 'whiskey-notes-dynamic-v7';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Installing Service Worker v7 with mobile optimizations...');
...
self.addEventListener('activate', (event) => {
  console.log('[SW] Activating Service Worker v7 with mobile optimizations...');
  ...
  event.waitUntil(
    caches.keys()
      ...
      .then(() => {
        console.log('[SW] All old caches deleted, Service Worker v7 activated');
        // 모든 클라이언트에 즉시 적용
...
console.log('[SW] Service Worker v7 script loaded');
